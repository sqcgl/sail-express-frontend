export default {
  ...
  admin: {
    ...
    form: {
      ...
      nameZh: "中文名称",
      nameEn: "英文名称",
      nameZhPlaceholder: "输入中文名称（可选）",
      nameEnPlaceholder: "输入英文名称",
      price: "价格",
      pricePlaceholder: "例如: ¥180/kg",
      category: "分类",
      description: "产品描述",
      descriptionZh: "中文描述",
      descriptionEn: "英文描述",
      descriptionZhPlaceholder: "输入中文描述",
      descriptionEnPlaceholder: "输入英文描述",
      image: "产品图片",
      submit: "提交",
      cancel: "取消",
      update: "更新产品",
      validation: {
        required: "请填写所有必填字段（英文名称、价格、分类）",
      },
      success: {
        add: "产品添加成功！",
        update: "产品更新成功！",
      ...
      confirm: {
        delete: '确定要删除产品 "{name}" 吗？',
      },
    },
    table: {
      title: "产品列表",
      showing: "显示 {filtered} / {total} 个产品",
      refresh: "刷新列表",
      loading: "正在加载产品数据...",
      id: "ID",
      image: "图片",

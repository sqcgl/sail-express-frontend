export default {
  ...
  about: {
    hero: {
      title: "关于我们",
      subtitle:
        "Sail Express 是专业的寿司海鲜餐厅物品批发商，致力于为寿司店提供最优质的食材和器具。我们拥有丰富的行业经验和专业的服务团队，是您值得信赖的合作伙伴。",
    },
    company: {
      title: "公司简介",
      paragraph1:
        "Sail Express 成立于2010年，专注于寿司和海鲜餐厅的食材供应。我们深知寿司制作对食材品质的严格要求，因此建立了严格的供应商筛选和质量控制体系。",
      paragraph2:
        "经过十多年的发展，我们已成为行业内知名的批发商，服务超过500家寿司店和海鲜餐厅，年营业额超过5000万元。",
      paragraph3:
        "我们的使命是让每一家寿司店都能获得最优质的食材，为顾客提供最美味的寿司体验。",
      stats: [
      ...
      items: [
        {
          year: "2010",
          title: "公司成立",
          desc: "在深圳成立，开始专注寿司食材批发",
        },
        {
          year: "2015",
          title: "业务扩张",
          desc: "服务客户超过100家，年营业额突破1000万",
        },
        {
          year: "2018",
          title: "品质升级",
          desc: "建立完整的质量追溯体系，获得ISO认证",
        },
        {
          year: "2023",
          title: "数字化转型",
          desc: "推出在线采购平台，实现全流程数字化管理",
        },
      ],
    },
    team: {
      ...
      members: [
        {
          name: "张海洋",
          position: "创始人 & CEO",
          desc: "拥有15年海鲜行业经验，曾任职多家知名海鲜企业高管",
        },
        {
          name: "李美玲",
          position: "采购总监",
          desc: "专业采购师，负责供应商管理和产品质量控制",
        },
        {
          name: "王建国",
          position: "运营总监",
          desc: "负责物流配送和客户服务，确保产品及时送达",
        },
      ],
    },
    clients: {
      title: "合作客户",
      client: "客户",
      description: "我们与众多知名寿司连锁店和高端海鲜餐厅建立了长期合作关系",
      learnMore: "了解更多客户案例",
    },
  },

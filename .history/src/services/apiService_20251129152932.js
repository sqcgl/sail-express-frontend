  ...
  if (!existingData) {
    const defaultProducts = [
      ...
      },
      {
        ...
        description_en: "NISSUI brand shrimp shumai, delicious flavor, ready to serve",
        price: "$58 / 箱",
        category: "frozen",
        image: null,
        created_at: new Date().toISOString(),
      },
      {
        ...
        description_en: "Premium vegetable gyoza, refreshing taste, healthy and nutritious",
        price: "$55 / 箱",
        category: "frozen",
        image: null,
        created_at: new Date().toISOString(),
      },
      {
        ...
        description_en: "Premium chicken and pork gyoza, rich flavor, ready to serve",
        price: "$55 / 箱",
        category: "frozen",
        image: null,
        created_at: new Date().toISOString(),
      ...
      },
      {
        ...
        description_en: "Premium sushi scallop, 2S size, sweet and fresh flavor",
        price: "$55 / 盒",
        category: "dry",
        image: null,
        created_at: new Date().toISOString(),
      },
      {
        ...
        description_en: "Premium sushi scallop, 1S size, sweet and fresh flavor",
        price: "询价 / 盒",
        category: "dry",
        image: null,
        created_at: new Date().toISOString(),
      ...
      },
      {
        ...
        description_en: "Premium kombu, 2.2 lb, for making Japanese dashi stock",
        price: "$60 / 箱",
        category: "dry",
        image: null,
        created_at: new Date().toISOString(),
      },
      {
        ...
        description_en: "Premium wakame, 1.1 lb per pack, 20 packs per box, rich in nutrients",
        price: "$18 / BAG",
        category: "dry",
        image: null,
        created_at: new Date().toISOString(),
      ...
      },
      {
        ...
        description_en: "Imported Taiwan edamame, 20 bags per package, sweet and fresh",
        price: "$32",
        category: "supply",
        image: null,
        created_at: new Date().toISOString(),
      ...
      },
      {
        ...
        description_en: "OSAKI brand crab stick, delicious flavor, perfect for sushi rolls",
        price: "$110 / 箱",
        category: "supply",
        image: null,
        created_at: new Date().toISOString(),
      },
      {
        ...
        description_en: "GOLD brand crab stick, delicious flavor, perfect for sushi rolls",
        price: "$75 / 箱",
        category: "supply",
        image: null,
        created_at: new Date().toISOString(),
      },
      {
        ...
        description_en: "BLUE brand crab stick, delicious flavor, perfect for sushi rolls",
        price: "$55 / 箱",
        category: "supply",
        image: null,
        created_at: new Date().toISOString(),
      ...
      },
      {
        ...
        description_en: "Sushi bar kitchen towel, 150 pieces per box, excellent absorbency",
        price: "$105 / 盒",
        category: "supply",
        image: null,
        created_at: new Date().toISOString(),
      },
      {
        ...
        description_en: "Premium rose napkin, 1000 pieces per box, soft and comfortable",
        price: "$35",
        category: "supply",
        image: null,
        created_at: new Date().toISOString(),
